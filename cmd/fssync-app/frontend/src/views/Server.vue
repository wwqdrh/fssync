<template>
    <div class="body">
        <el-button class="setting-btn" @click="gotoclient()" type="default" size="mini" title="下载页面">下载页面
        </el-button>
        <div class="container">
            <el-button class="setting-btn" @click="onHandlerSetting()" type="default" size="mini" :icon="Setting"
                title="设置">设置
            </el-button>
                ...
                <el-space size="large" direction="vertical">
                    <el-card class="box-card">
                        ...
                        <el-row class="row-bg">
                            ...
                            <el-col :span="4">
                                <el-button type="default" size="mini" icon="el-icon-sort" title="切换ip协议"
                                    @click="changeIpFamily()">协议：{{
                                        ipFamily }}
                                </el-button>
                            </el-col>
                            <el-col :span="4">
                                <el-button v-if="netInterfaceNames.length > 1" type="default" size="mini"
                                    icon="el-icon-sort" title="切换网卡" @click="changeNetInterface()">网卡：{{
                        ...
                        <div v-for="file in files" :key="file" class="text item file-item">
                            <el-row class="row-bg" justify="space-between">
                                ...
                                <el-col :span="6">
                                    ...
                                    <el-button v-if="['directory', 'file'].includes(file.type)" type="default"
                                        size="mini" icon="el-icon-search" title="打开文件所在目录"
...
export default {
    ...
    methods: {
        gotoclient() {
            console.log("client");
            this.$router.push({ name: 'client', path: '/client' })
        },
